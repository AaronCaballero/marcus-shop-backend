...
export class SeedProductsAndCustomizations1741948800000 implements MigrationInterface {
  name = 'SeedProductsAndCustomizations1741948800000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      ('Silver Rims', 'Classic silver rims', 30.00, 60, 'bicycles', 'rim_color', false),
      ...
      ('Blue Color', 'Blue bicycle frame', 0.00, 200, 'bicycles', 'color', false),
      ...
      ('Aluminum Material', 'Lightweight aluminum frame', 150.00, 40, 'bicycles', 'material', false),
