...
export class CreateProductCustomization1741680542991 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."product_customizations_type_enum" AS ENUM('frame_type', 'frame_finish', 'wheels', 'rim_color', 'chain', 'color', 'size', 'material', 'aditional_feature')`);
